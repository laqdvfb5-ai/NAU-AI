...
- `/admin/api-pool`: kho nhiều API/model với mẫu OpenAI, Gemini, OpenRouter, Ollama, vLLM và API tương thích. Lưu key mã hóa, tải model, gửi thử streaming, xem độ trễ/chi phí, chọn API thủ công hoặc phân phối lần lượt cho chat.
